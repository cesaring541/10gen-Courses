...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        cursor = self.posts.find().limit(num_posts)        # Placeholder so blog compiles before you make your changes
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            last_error = self.posts.update({'permalink':permalink},{'$push':{'comments':comment}})           # this is here so the code runs before you fix the next line
